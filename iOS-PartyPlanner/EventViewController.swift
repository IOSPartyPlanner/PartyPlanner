...
extension EventViewController: EditPhotoViewControllerDelegate {
  func editPhotoViewController(editPhotoViewController: EditPhotoViewController, imageSaved:  UIImage) {
    
    let imageName = "stickerstickerImage.jpeg"
    let data = UIImageJPEGRepresentation(imageSaved, 1)
